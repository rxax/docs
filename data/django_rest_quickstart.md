...
Add the cors configuration to `app/settings.py`

- Allow all addresses to access the API:
...
Note that the frontend has to run from a local server, ex.:
